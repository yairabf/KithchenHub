...
export const mockRecipes: Recipe[] = [
  {
    ...
    servings: 4,
    ingredients: [
      { id: '1-1', quantity: '2', unit: 'cups', name: 'All-purpose Flour' },
      { id: '1-2', quantity: '2', unit: 'tsp', name: 'Baking Powder' },
      { id: '1-3', quantity: '1.5', unit: 'cups', name: 'Milk' },
      { id: '1-4', quantity: '2', unit: 'pcs', name: 'Large Eggs' },
      { id: '1-5', quantity: '1', unit: 'cup', name: 'Mixed Berries' },
      { id: '1-6', quantity: '0.5', unit: 'cup', name: 'Maple Syrup' },
      { id: '1-7', quantity: '3', unit: 'tbsp', name: 'Butter' },
    ],
    instructions: [
  ...
  },
  {
    ...
    servings: 4,
    ingredients: [
      { id: '2-1', quantity: '400', unit: 'g', name: 'Spaghetti' },
      { id: '2-2', quantity: '200', unit: 'g', name: 'Pancetta' },
      { id: '2-3', quantity: '4', unit: 'pcs', name: 'Large Eggs' },
      { id: '2-4', quantity: '1', unit: 'cup', name: 'Parmesan Cheese' },
      { id: '2-5', quantity: '2', unit: 'cloves', name: 'Garlic' },
      { id: '2-6', quantity: '2', unit: 'tbsp', name: 'Olive Oil' },
      { id: '2-7', quantity: '1', unit: 'tsp', name: 'Black Pepper' },
    ],
    instructions: [
  ...
  },
  {
    ...
    servings: 2,
    ingredients: [
      { id: '3-1', quantity: '1', unit: 'head', name: 'Romaine Lettuce' },
      { id: '3-2', quantity: '0.5', unit: 'cup', name: 'Parmesan Cheese' },
      { id: '3-3', quantity: '1', unit: 'cup', name: 'Croutons' },
      { id: '3-4', quantity: '2', unit: 'cloves', name: 'Garlic' },
      { id: '3-5', quantity: '2', unit: 'tbsp', name: 'Lemon Juice' },
      { id: '3-6', quantity: '1', unit: 'tsp', name: 'Dijon Mustard' },
      { id: '3-7', quantity: '0.5', unit: 'cup', name: 'Olive Oil' },
      { id: '3-8', quantity: '2', unit: 'fillets', name: 'Anchovy' },
    ],
    instructions: [
  ...
  },
  {
    ...
    servings: 6,
    ingredients: [
      { id: '4-1', quantity: '2', unit: 'lbs', name: 'Roma Tomatoes' },
      { id: '4-2', quantity: '1', unit: 'medium', name: 'Onion' },
      { id: '4-3', quantity: '4', unit: 'cloves', name: 'Garlic' },
      { id: '4-4', quantity: '2', unit: 'cups', name: 'Vegetable Broth' },
      { id: '4-5', quantity: '0.5', unit: 'cup', name: 'Heavy Cream' },
      { id: '4-6', quantity: '0.25', unit: 'cup', name: 'Fresh Basil' },
      { id: '4-7', quantity: '2', unit: 'tbsp', name: 'Olive Oil' },
      { id: '4-8', quantity: '1', unit: 'tsp', name: 'Sugar' },
    ],
    instructions: [
  ...
  },
  {
    ...
    servings: 4,
    ingredients: [
      { id: '5-1', quantity: '4', unit: 'pcs', name: 'Chicken Breast' },
      { id: '5-2', quantity: '3', unit: 'tbsp', name: 'Olive Oil' },
      { id: '5-3', quantity: '2', unit: 'tbsp', name: 'Lemon Juice' },
      { id: '5-4', quantity: '3', unit: 'cloves', name: 'Garlic' },
      { id: '5-5', quantity: '1', unit: 'tsp', name: 'Dried Oregano' },
      { id: '5-6', quantity: '1', unit: 'tsp', name: 'Dried Thyme' },
      { id: '5-7', quantity: '1', unit: 'tsp', name: 'Paprika' },
      { id: '5-8', quantity: '0.5', unit: 'tsp', name: 'Salt' },
    ],
    instructions: [
  ...
  },
  {
    ...
    servings: 4,
    ingredients: [
      { id: '6-1', quantity: '8', unit: 'slices', name: 'Brioche Bread' },
      { id: '6-2', quantity: '4', unit: 'pcs', name: 'Large Eggs' },
      { id: '6-3', quantity: '1', unit: 'cup', name: 'Milk' },
      { id: '6-4', quantity: '1', unit: 'tsp', name: 'Vanilla Extract' },
      { id: '6-5', quantity: '1', unit: 'tsp', name: 'Cinnamon' },
      { id: '6-6', quantity: '2', unit: 'tbsp', name: 'Butter' },
      { id: '6-7', quantity: '0.25', unit: 'cup', name: 'Powdered Sugar' },
    ],
    instructions: [
