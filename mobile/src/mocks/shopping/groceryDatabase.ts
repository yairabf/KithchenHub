...
export const mockGroceriesDB: GroceryItem[] = [
  ...
  { id: 'g112', name: 'Soda', image: 'https://images.unsplash.com/photo-1629203851122-3726ecdf080e?w=100', category: 'Beverages', defaultQuantity: 6 },
  ...
  { id: 'g113', name: 'Canned Beans', image: 'https://images.unsplash.com/photo-1589367920969-ab8e050bbb04?w=100', category: 'Canned', defaultQuantity: 3 },
  ...
  { id: 'g100', name: 'Cookies', image: 'https://images.unsplash.com/photo-1558961363-fa8fdf82db35?w=100', category: 'Bakery', defaultQuantity: 1 },
  { id: 'g101', name: 'Brownies', image: 'https://images.unsplash.com/photo-1607920591413-4ec007e70023?w=100', category: 'Bakery', defaultQuantity: 1 },
  ...
  // === HOUSEHOLD (Test: "cups", "plates", "household") ===
  { id: 'g114', name: 'Party Cups', image: 'https://images.unsplash.com/photo-1559827260-dc66d52bef19?w=100', category: 'Household', defaultQuantity: 50 },
  { id: 'g115', name: 'Paper Towels', image: 'https://images.unsplash.com/photo-1621864486531-97e3203a78f4?w=100', category: 'Household', defaultQuantity: 2 },
  { id: 'g116', name: 'Dishwasher Tablets', image: 'https://images.unsplash.com/photo-1621864486531-97e3203a78f4?w=100', category: 'Household', defaultQuantity: 1 },
  { id: 'g117', name: 'Soap', image: 'https://images.unsplash.com/photo-1621864486531-97e3203a78f4?w=100', category: 'Household', defaultQuantity: 2 },
  
  // === SPICES (Test: "salt", "pepper", "spices") ===
  { id: 'g118', name: 'Salt', image: 'https://images.unsplash.com/photo-1607613009820-a29f7bb81c1f?w=100', category: 'Spices', defaultQuantity: 1 },
  { id: 'g119', name: 'Black Pepper', image: 'https://images.unsplash.com/photo-1607613009820-a29f7bb81c1f?w=100', category: 'Spices', defaultQuantity: 1 },
  { id: 'g120', name: 'Garlic Powder', image: 'https://images.unsplash.com/photo-1607613009820-a29f7bb81c1f?w=100', category: 'Spices', defaultQuantity: 1 },
  { id: 'g121', name: 'Onion Powder', image: 'https://images.unsplash.com/photo-1607613009820-a29f7bb81c1f?w=100', category: 'Spices', defaultQuantity: 1 },
  { id: 'g122', name: 'Paprika', image: 'https://images.unsplash.com/photo-1607613009820-a29f7bb81c1f?w=100', category: 'Spices', defaultQuantity: 1 },
  { id: 'g123', name: 'Cumin', image: 'https://images.unsplash.com/photo-1607613009820-a29f7bb81c1f?w=100', category: 'Spices', defaultQuantity: 1 },
  { id: 'g124', name: 'Oregano', image: 'https://images.unsplash.com/photo-1607613009820-a29f7bb81c1f?w=100', category: 'Spices', defaultQuantity: 1 },
  { id: 'g125', name: 'Basil', image: 'https://images.unsplash.com/photo-1607613009820-a29f7bb81c1f?w=100', category: 'Spices', defaultQuantity: 1 },
  
  // === OTHER (Test: "misc", "other") ===
  { id: 'g126', name: 'Miscellaneous', image: 'https://images.unsplash.com/photo-1559827260-dc66d52bef19?w=100', category: 'Other', defaultQuantity: 1 },
];
