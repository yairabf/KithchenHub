      ...
      const mockQueue: QueuedWrite[] = [
        {
          ...
          op: 'create',
          target: { localId: 'local-123' },
          payload: { id: 'local-123', title: 'Test', ingredients: [], instructions: [] },
          clientTimestamp: new Date().toISOString(),
          attemptCount: 0,
        },
      ];
      ...
      const mockQueue: QueuedWrite[] = [
        {
          ...
          op: 'create',
          target: { localId: 'local-123' },
          payload: { id: 'local-123', title: 'Test Recipe', ingredients: [], instructions: [] },
          clientTimestamp: new Date().toISOString(),
          attemptCount: 0,
          status: 'PENDING',
        },
      ...
      const mockQueue: QueuedWrite[] = [
        {
          ...
          payload: { id: 'recipe-1', title: 'Recipe 1', ingredients: [], instructions: [] },
          clientTimestamp: new Date().toISOString(),
          attemptCount: 0,
          status: 'PENDING',
        },
        {
          ...
          payload: { id: 'recipe-2', title: 'Recipe 2', ingredients: [], instructions: [] },
          clientTimestamp: new Date().toISOString(),
          attemptCount: 0,
          status: 'PENDING',
        },
    ...
    it('should retry only failed items after partial failure', async () => {
      const mockQueue: QueuedWrite[] = [
        ...
        },
        {
          ...
          payload: { id: 'recipe-3', title: 'Recipe 3', ingredients: [], instructions: [] },
          clientTimestamp: new Date().toISOString(),
          attemptCount: 0,
          status: 'PENDING',
        },
