...
# Checks: updates block exists, runtimeVersion exists, and url does not contain [PROJECT_ID] placeholder.
...
echo "OTA config OK: updates and runtimeVersion present; url has no placeholder"
exit 0
