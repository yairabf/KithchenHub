    ...
    describe.each([
      ...
      [
        ...
        [
          ...
          {
            sourceField: 'recipe-2',
            sourceType: 'RECIPE',
            targetField: 'server-recipe-2',
          },
          {
            sourceField: 'list-1',
      ...
      (
        ...
        it(testDescription, async () => {
          mockPrismaService.importMapping.findMany.mockResolvedValue(
            mockMappings,
          );

          const result = await repository.findMappingsForUser(
            userId,
            sourceFields,
          );
          ...
          if (sourceFields.length === 0) {
            expect(
              mockPrismaService.importMapping.findMany,
