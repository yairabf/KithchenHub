...
describe('SupportTicketRateLimitGuard', () => {
  it('requires an authenticated user before checking rate-limit quota', () => {
    const service = {
      check: jest.fn(),
  ...
  it('allows the request without consuming quota when the user has support-ticket quota', () => {
    const service = {
